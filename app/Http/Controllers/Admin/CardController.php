...
class CardController extends Controller
{
    ...
    {
        $cards = Card::query()
            // ⚡ Bolt: Eager load only required relations and their needed columns for the index view
            // to significantly reduce memory usage, N+1 query overhead, and JSON payload size.
