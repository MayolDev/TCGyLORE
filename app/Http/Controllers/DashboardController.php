...
class DashboardController extends Controller
{
    ...
    {
        // ⚡ Bolt Optimization: Group by at the DB level instead of loading all models into memory O(N)
        $cardsByRarity = Card::select('rarity_id', DB::raw('count(*) as count'))
            ...
            ->mapWithKeys(function ($item) {
                // Handle naming conflict on `rarity` attribute vs relation using relationLoaded
