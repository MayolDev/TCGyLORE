...
class DashboardController extends Controller
{
    ...
    {
        // Optimization: Perform count at database level instead of loading all models into memory
        // O(N) memory operation converted to O(R) where R is the number of rarities
