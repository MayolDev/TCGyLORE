...
export default function AuthSimpleLayout({
    ...
    return (
        <>
            ...
            {/* Background épico */}
            <div className="relative flex flex-col items-center justify-center min-h-svh gap-6 overflow-hidden bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900 p-6 md:p-10">
                {/* Efectos de luz múltiples */}
                <div className="absolute inset-0">
                    <div className="absolute top-1/4 left-1/4 h-96 w-96 animate-pulse-slow rounded-full bg-purple-600 opacity-20 blur-3xl filter mix-blend-screen"></div>
                    <div className="animation-delay-2000 absolute bottom-1/4 right-1/4 h-96 w-96 animate-pulse-slow rounded-full bg-orange-600 opacity-20 blur-3xl filter mix-blend-screen"></div>
                    <div className="animation-delay-1000 absolute top-1/2 left-1/2 h-64 w-64 animate-pulse-slow rounded-full bg-yellow-500 opacity-15 blur-3xl filter mix-blend-screen"></div>
                    <div className="animate-float absolute top-10 right-10 h-40 w-40 rounded-full bg-pink-500 opacity-20 blur-3xl filter mix-blend-screen"></div>
                    <div className="animate-float animation-delay-1500 absolute bottom-10 left-10 h-40 w-40 rounded-full bg-blue-500 opacity-20 blur-3xl filter mix-blend-screen"></div>
                </div>
