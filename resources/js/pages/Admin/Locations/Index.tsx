                                    ...
                                    <CardContent className="relative z-10 space-y-4">
                                        ...
                                        <div className="flex gap-2 pt-2">
                                            <Button
                                                ...
                                                aria-label={`Editar locación ${location.name}`}
                                                title={`Editar locación ${location.name}`}
                                                asChild
                                            >
                                                <Link
                                            ...
                                            <Button
                                                ...
                                                aria-label={`Eliminar locación ${location.name}`}
                                                title={`Eliminar locación ${location.name}`}
                                            >
