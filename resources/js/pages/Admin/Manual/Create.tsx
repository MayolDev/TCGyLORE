...
import { rehypeSanitizeOptions } from '@/lib/rehype-config';
...
export default function Create({ categories, sections, nextOrders }: Props) {
    ...
    // Actualizar el orden cuando cambia la categoría
    const handleCategoryChange = (newCategory: string) => {
        setData({
            ...data,
            category: newCategory,
            order: nextOrders[newCategory] || 0,
        });
    };

    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/admin/manual-sections');
    };
    ...
    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            <Head title="Crear Sección del Manual" />
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <Card className="border-primary/20">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Configura los datos principales de la sección
                            </CardDescription>
                        </CardHeader>
