...
export default function Register() {
    return (
        <AuthLayout
            ...
            description="Crea tu cuenta para comenzar tu aventura épica"
        >
                    ...
                    <>
                        <div className="grid gap-6">
                            ...
                            <div className="text-center text-sm text-yellow-200/60">
                                ...
                                <TextLink href={route('login')} className="text-yellow-400 hover:text-yellow-300 font-semibold" tabIndex={6}>
                                    Entrar al Reino
                                </TextLink>
                            </div>
                        </div>
