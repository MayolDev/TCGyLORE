...
export default function Register() {
    return (
        <AuthLayout
            ...
            description="Crea tu cuenta para comenzar tu viaje legendario"
        >
                    ...
                    <>
                        <div className="grid gap-6">
                            ...
                            <div className="flex items-center justify-end">
                                <Link
                                    href="/login"
                                    className="underline text-sm text-yellow-400 hover:text-yellow-300 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"
                                >
                                    ¿Ya tienes cuenta?
                                </Link>
                            </div>
