...
export default function Register() {
    return (
        <AuthLayout
            ...
            description="Crea tu cuenta y comienza tu aventura épica"
        >
                ...
                {({ processing, errors }) => (
                    <>
                        ...
                        <div className="text-center text-sm text-yellow-200/70">
                            ...
                            <Link
                                href={login()}
                                className="text-yellow-400 hover:text-yellow-300 font-bold underline decoration-yellow-400/50 hover:decoration-yellow-300 transition-all"
                            >
                                Inicia sesión aquí
                            </Link>
                        </div>
