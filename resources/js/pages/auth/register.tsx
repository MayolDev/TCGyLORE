...
export default function Register() {
    return (
        <AuthLayout
            ...
            description="Crea tu cuenta y comienza tu aventura en este mundo mágico"
        >
            ...
            >
                {({ processing, errors }) => (
                    <>
                        ...
                        <div className="text-center text-sm text-yellow-200/60">
                            ¿Ya tienes una cuenta?{' '}
                            <TextLink href={login()} className="text-yellow-400 hover:text-yellow-300 font-bold hover:underline">
                                Iniciar Sesión
                            </TextLink>
                        </div>
                    </>
