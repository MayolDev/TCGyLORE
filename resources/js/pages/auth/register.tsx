...
export default function Register() {
    return (
        <AuthLayout
            ...
            description="Crea tu cuenta para comenzar tu viaje en Tapon'Azo"
        >
                ...
                {({ processing, errors }) => (
                    <>
                        ...
                        <div className="text-center text-sm text-yellow-200/70">
                            ...
                            <Link
                                href="/login"
                                className="text-yellow-400 hover:text-yellow-300 font-semibold underline decoration-yellow-600/50 hover:decoration-yellow-400"
                            >
                                Inicia sesión aquí
                            </Link>
                        </div>
