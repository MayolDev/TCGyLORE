...
export default function Register() {
    return (
        <AuthLayout
            ...
            description="Crea tu cuenta para comenzar tu aventura"
        >
                    ...
                    <>
                        <div className="grid gap-6">
                            ...
                            <div className="flex items-center justify-between mt-2">
                                <TextLink href={login()} className="text-sm text-yellow-400 hover:text-yellow-300 font-semibold">
                                    ¿Ya tienes cuenta?
                                </TextLink>
                            </div>
                            ...
                            <Button
                                type="submit"
                                className="mt-2 w-full bg-gradient-to-r from-yellow-600 via-orange-600 to-red-600 hover:from-yellow-500 hover:to-red-500 text-white font-black text-lg shadow-2xl shadow-orange-500/50 hover:shadow-orange-400/70 border-2 border-yellow-400/30 hover:scale-105 transition-all tracking-wider"
                                tabIndex={5}
                                disabled={processing}
