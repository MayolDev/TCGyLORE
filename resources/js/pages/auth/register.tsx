...
export default function Register() {
    return (
        <AuthLayout
            ...
            description="Crea tu cuenta y comienza tu viaje en Tapon'Azo"
        >
                ...
                {({ processing, errors }) => (
                    <>
                        <div className="grid gap-6">
                            ...
                            <div className="text-center text-sm text-yellow-200/60 mt-2">
                                ¿Ya tienes cuenta?{' '}
                                <TextLink href={login()} className="text-yellow-400 hover:text-yellow-300 font-bold" tabIndex={6}>
                                    Inicia Sesión
                                </TextLink>
                            </div>
                        </div>
