...
// @ts-expect-error - Leaflet types definition issue
...
export default function LocationMapPicker({
    ...
    }, [latitude, longitude]); // mapRef y markerRef son refs, no necesitan estar en deps, pero onLocationChange no se usa aquí.
