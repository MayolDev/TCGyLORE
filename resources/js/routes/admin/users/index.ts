...
* @see Http/Controllers/Admin/UserController.php:18
* @route '/admin/users'
*/
...
* @see Http/Controllers/Admin/UserController.php:39
...
* @see Http/Controllers/Admin/UserController.php:51
* @route '/admin/users'
*/
...
* @see Http/Controllers/Admin/UserController.php:76
...
* @see Http/Controllers/Admin/UserController.php:88
...
* @see Http/Controllers/Admin/UserController.php:102
* @route '/admin/users/{user}'
*/
...
* @see Http/Controllers/Admin/UserController.php:128
* @route '/admin/users/{user}'
*/
