...
* @see Http/Controllers/Admin/LocationController.php:28
...
* @see Http/Controllers/Admin/LocationController.php:53
...
* @see Http/Controllers/Admin/LocationController.php:61
* @route '/admin/locations'
*/
...
* @see Http/Controllers/Admin/LocationController.php:85
...
* @see Http/Controllers/Admin/LocationController.php:96
* @route '/admin/locations/{location}'
*/
...
* @see Http/Controllers/Admin/LocationController.php:124
* @route '/admin/locations/{location}'
*/
