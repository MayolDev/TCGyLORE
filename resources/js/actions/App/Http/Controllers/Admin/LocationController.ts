...
* @see Http/Controllers/Admin/LocationController.php:14
...
* @see Http/Controllers/Admin/LocationController.php:55
...
* @see Http/Controllers/Admin/LocationController.php:79
* @route '/admin/locations'
*/
...
* @see Http/Controllers/Admin/LocationController.php:0
...
* @see Http/Controllers/Admin/LocationController.php:104
...
* @see Http/Controllers/Admin/LocationController.php:131
* @route '/admin/locations/{location}'
*/
...
* @see Http/Controllers/Admin/LocationController.php:160
* @route '/admin/locations/{location}'
*/
